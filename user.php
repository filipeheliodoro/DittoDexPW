...
try {
    ...
    foreach ($favorites as &$favorite) {
        ...
        if ($pokemonData !== false) {
            ...
            $favorite['pokemon_image'] = $pokemonData['sprites']['front_default'] ?? null; 
        } else {
            $favorite['pokemon_image'] = null; 
        }
    }
            ...
            <ul>
                <?php foreach ($favorites as $favorite): ?>
                    <li>
                        ...
                        <strong><?= htmlspecialchars($favorite['pokemon_name']) ?></strong> (ID: <?= $favorite['pokemon_id'] ?>)
